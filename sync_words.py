...
CATEGORY_RULES = [
    ...
    ("乐器们", ["吉他", "钢琴", "键盘", "贝斯", "鼓", "打击乐", "沙锤", "康加", "邦戈", "金贝", "铃鼓",
                ...
                "弦乐", "铜管", "木管", "合成器", "铺底", "主音", "声码器",
                "guitar", "piano", "synth", "synthesizer", "organ", "keys", "keyboard",
                ...
                "pad", "lead", "pluck", "arp", "808", "vocoder"]),
    ...
    ("音乐词汇", ["和弦", "旋律", "节奏", "律动", "速度", "调性", "音阶", "音符", "主歌", "副歌", "桥段",
                  ...
                  "拉丁", "管弦", "电影配乐", "氛围音乐", "人声", "音效", "氛围音", "拟音",
                  "chord", "melody", "rhythm", "groove", "tempo",
                  ...
                  "vocal", "vocals", "voice", "choir", "riser", "impact", "downer", "atmosphere",
                  "ambience", "foley", "drone", "reverse", "field recording", "oscillator", "waveform",
                  "granular", "synthesis", "wobble"]),
]
...
WORD_CATEGORY = {
    ...
    "aggressive rock male vocals": "音乐词汇",
    "airy": "声音描述",
    "aligning": "插件操作",
    "alter": "插件操作",
    "ambience": "音乐词汇",
    ...
    "genre": "音乐词汇",
    "gentle": "声音描述",
    "glitchy ambient voice": "音乐词汇",
    "glm-calibrated": "音乐词汇",
    "gore": "音乐词汇",
    "granular cinematic pads": "乐器们",
    "granular synthesis": "音乐词汇",
    "gritty": "声音描述",
    "groove": "音乐词汇",
